...
<head>
    ...
    <meta name="description" content="CheckData AI — Autodiagnóstico de cumplimiento de la Ley 1581 de Protección de Datos para PYMEs colombianas.">

    <title>CheckData AI — Autodiagnóstico Ley 1581</title>
        ...
        <section class="relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
                <div class="max-w-3xl mx-auto text-center">
                    <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-high-bg text-high-text text-sm font-semibold rounded-full mb-6">
...
CheckData AI es la herramienta gratuita de autodiagnóstico que ayuda a su PYME 
        ...
        <section id="features" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl sm:text-4xl font-bold text-sidebar-dark mb-4">¿Por qué CheckData AI?</h2>
                    <p class="text-lg text-muted-text max-w-2xl mx-auto">
                        ...
                        <strong>CheckData AI es la tercera opción.</strong>
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-bg-page rounded-2xl p-8 hover:shadow-lg transition border border-border-light">
                        <div class="w-14 h-14 bg-high-bg rounded-xl flex items-center justify-center mb-6">
                            <x-icon name="file-check" class="w-7 h-7 text-high-text" />
                        </div>
                    ...
                    <div class="bg-bg-page rounded-2xl p-8 hover:shadow-lg transition border border-border-light">
                        <div class="w-14 h-14 bg-high-bg rounded-xl flex items-center justify-center mb-6">
                            <x-icon name="shield" class="w-7 h-7 text-primary" />
                        </div>
                    ...
                    <div class="bg-bg-page rounded-2xl p-8 hover:shadow-lg transition border border-border-light">
                        <div class="w-14 h-14 bg-medium-bg rounded-xl flex items-center justify-center mb-6">
                            <x-icon name="bolt" class="w-7 h-7 text-medium-text" />
                        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                    <div class="text-center">
                        <div class="w-16 h-16 bg-sidebar-dark text-white rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <x-icon name="user-plus" class="w-8 h-8" />
                        </div>
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 bg-sidebar-dark text-white rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <x-icon name="clipboard-check" class="w-8 h-8" />
                        </div>
                        <h3 class="text-lg font-bold text-sidebar-dark mb-2">Responde</h3>
                        <p class="text-muted-text">Completa el cuestionario de 11 preguntas sobre sus prácticas de protección de datos.</p>
                    </div>
                    <div class="text-center">
                        <div class="w-16 h-16 bg-sidebar-dark text-white rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <x-icon name="rocket" class="w-8 h-8" />
                        </div>
...
<a href="{{ route('register') }}" 
                    ...
                    <x-icon name="chevron-right" class="w-5 h-5 ml-2" />
                </a>
            </div>
        </section>
